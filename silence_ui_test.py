# -*- coding: utf-8 -*-
"""Тишина на дорожке не должна глушить кнопку записи.

Сама проверка написана на JS и гоняет настоящий web/app.js в node:
беда была во фронте, и проверять её пересказом на питоне бессмысленно.
...
итог = subprocess.run(
    [node, str(КОРЕНЬ / "silence_ui_test.js")],
