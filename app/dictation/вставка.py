...
# Сколько ждать между Ctrl+V и возвратом прежнего буфера.
#
# Приложение забирает содержимое буфера не в тот же миг. Вернув прежнее
# слишком рано, мы вставим именно прежнее: человек продиктует фразу, а
# получит то, что копировал полчаса назад.
ПАУЗА_БУФЕРА = 0.12
